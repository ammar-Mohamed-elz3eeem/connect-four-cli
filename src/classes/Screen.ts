...
export default class Screen {
	 ...
	 */
	public static numCols: number;

	/**
	 * This is the number of rows that the screen has.
	 */
	public static numRows: number;
	 ...
	 *     rendered.
	 */
	public static initialize(numRows: number, numCols: number) {
	...
	public static printCommands() {
		...
		for (let cmd in Screen.commands) {
			let description = Screen.commands[cmd]!.getDescription();
	 ...
	 *     command is called.
	 */
	public static setQuitMessage(quitMessage: string) {
